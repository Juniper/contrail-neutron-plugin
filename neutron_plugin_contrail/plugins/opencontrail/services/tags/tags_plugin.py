...
class TagsPlugin(service_base.ServicePluginBase):
    ...
    def get_tags(self, context, parent, parent_id):
        ...
        :return:
        """
        return self._core_plugin._list_resource('tags', context, parent_id)
    ...
    def get_tag(self, context, parent, parent_id, id):
        ...
        :return:
        """
        return self._core_plugin._read_resource('tags', context, id)
    ...
    def delete_tag(self, context, parent, parent_id, id):
        ...
        res_data = {'parent_id': parent_id, 'tags': [id]}
        self._core_plugin._delete_resource('tags', context, res_data)
