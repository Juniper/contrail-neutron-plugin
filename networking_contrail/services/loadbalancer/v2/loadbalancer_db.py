...
from networking_contrail.services.loadbalancer.v2 import listener
from networking_contrail.services.loadbalancer.v2 import loadbalancer
from networking_contrail.services.loadbalancer.v2 import\
    loadbalancer_healthmonitor
from networking_contrail.services.loadbalancer.v2 import loadbalancer_member
from networking_contrail.services.loadbalancer.v2 import loadbalancer_pool
...
class LoadBalancerPluginDbV2(LoadBalancerPluginBaseV2):
    ...
    def get_loadbalancers(self, context, filters=None, fields=None):
        ...
        return self.loadbalancer_manager.get_collection(context, filters,
                                                        fields)
    ...
    def get_pool_members(self, context, pool_id, filters=None, fields=None):
        self.api.set_auth_token(context.auth_token)
        return self.member_manager.get_collection(context, pool_id, filters,
                                                  fields)
