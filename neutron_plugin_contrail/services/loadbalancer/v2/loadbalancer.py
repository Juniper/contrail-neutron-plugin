...
class LoadbalancerManager(ResourceManager):
    ...
    def create(self, context, loadbalancer):
        ...
        if (lb['provider'] == ATTR_NOT_SPECIFIED):
            lb['provider'] = "opencontrail"
        sas_obj = self.check_provider_exists(lb['provider'])
