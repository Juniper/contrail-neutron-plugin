...
class ListenerManager(ResourceManager):
    ...
    def _get_vip_pool_id(self, vip):
        pool_refs = vip.get_listener_pool_refs()
    ...
    def make_dict(self, ll, fields=None):
        ...
        res = {'id': ll.uuid,
               ...
               'status': self._get_object_status(ll)}
    ...
    def update_properties(self, ll_db, id, ll):
        ...
        if self._update_loadbalancer_listener_properties(props, id, ll):
