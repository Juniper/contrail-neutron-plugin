...
class LogicalRouterMixin(object):
    ...
    def _get_external_gateway_info(self, rtr_obj):
        ...
        vm_ref = si_obj.get_virtual_machine_back_refs()[0]
        ...
        for vmi_ref in vm_obj.get_virtual_machine_interface_back_refs() or []:
            ...
            if vmi_obj.get_virtual_machine_interface_properties().service_interface_type == 'right':
                iip_obj = self._vnc_lib.instance_ip_read(id=vmi_obj.get_instance_ip_back_refs()[0]['uuid'])
