...
unsupported_pool_opts = ["tls_container_ref",
                         "ca_tls-container_ref",
                         "crl_container_ref"]

unsupported_member_opts = ["monitor_address",
                           "monitor_port",
                           "backup"]
...
MEMBER_TYPE = "loadbalancer-member"
...
RESOURCE_INFO = {
    ...
    MEMBER_TYPE: {
            GET_PROPS: "get_loadbalancer_member_properties",
            SET_PROPS: "set_loadbalancer_member_properties",
            ATTR_MAP: member_type_mapping
    },
}
