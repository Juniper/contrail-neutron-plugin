...
class ContrailProviderDriver(driver_base.ProviderDriver):
    ...
    def update_resource(self, old_obj, updated_opts, res_type, res_id, proj_id):
    ...
    def loadbalancer_update(self, old_lb, new_lb):
        ...
        self.update_resource(old_lb, updated_opts, c_const.LOADBALANCER_TYPE,
    ...
    def listener_update(self, old_listener, new_listener):
        ...
        self.update_resource(old_listener, updated_opts,
                             c_const.LISTENER_TYPE,
    ...
    def pool_update(self, old_pool, new_pool):
        ...
        self.update_resource(old_pool, updated_opts,
                             c_const.POOL_TYPE,
                             old_pool.pool_id,
                             old_pool.project_id)
