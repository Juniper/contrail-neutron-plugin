...
class NeutronPluginContrailCoreBase(neutron_plugin_base_v2.NeutronPluginBaseV2,
    ...
    def update_port(self, context, port_id, port):
        ...
        if self._port_vnic_is_normal(original):
            ...
            # If the port vnic is not normal it is SRIOV. Set correct vif_type
            # and delete any vhostuser related fields.
            port['port'][portbindings.VIF_TYPE] = portbindings.VIF_TYPE_HW_VEB
            self._delete_vhostuser_vif_details_from_port(port['port'],
                                                         original)
