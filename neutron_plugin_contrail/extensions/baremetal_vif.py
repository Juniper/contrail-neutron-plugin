...
class BaremetalVIF(ExtensionDescriptor):
    @classmethod
    def get_name(cls):
        return "BaremetalVIF"
    ...
    @classmethod
    def get_alias(cls):
        return "baremetal-vif"

    @classmethod
    def get_description(cls):
        return "Baremetal VIF extension"

    @classmethod
    def get_updated(cls):
        return "2018-06-11T17:00:00-00:00"
    ...
    def should_bind_port(self, port):
