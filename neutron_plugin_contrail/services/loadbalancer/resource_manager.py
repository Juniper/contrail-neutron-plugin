...
class ResourceManager(object):
    ...
    def property_type_mapping(self):
        """Map property name to neutron dict key."""
        pass

    @abstractmethod
    def make_properties(self, resource):
        """Return the properties for the specified resource."""
        pass

    @abstractmethod
    def make_dict(self, resource, fields):
        """Format resource dict.

        Returns the contrail api resource in the dictionary format
        expected by neutron.
        """
        pass
    ...
    def resource_list(self, tenant_id):
        """Return the list of objects from the api server."""
        pass
    ...
    def get_exception_notfound(self, id):
        """Return the correct NotFound exception."""
        pass
    ...
    def _get_resource_name(self, resource, parent, name, uuid):
        ...
        This is display name if there are no conflicts or display_name + uuid.
        """
    ...
    def _project_read(self, project_id):
        """Read the project from the api server.

        The project will be created it does not yet exist.
        """
