...
class LoadBalancerPluginDbV2(LoadBalancerPluginBaseV2):
    ...
    def create_loadbalancer(self, context, loadbalancer):
        try:
            ...
            raise exc.BadRequest(resource='loadbalancer', msg=str(ex))
    ...
    def create_listener(self, context, listener):
        try:
            ...
            raise exc.BadRequest(resource='listener', msg=str(ex))
    ...
    def create_pool(self, context, pool):
        try:
            ...
            raise exc.BadRequest(resource='pool', msg=str(ex))
    ...
    def create_pool_member(self, context, pool_id, member):
        try:
            ...
            raise exc.BadRequest(resource='member', msg=str(ex))
    ...
    def create_healthmonitor(self, context, healthmonitor):
        try:
            ...
            raise exc.BadRequest(resource='healthmonitor', msg=str(ex))
