...
from networking_contrail.common import utils
...
class ContrailPluginBase(neutron_plugin_base_v2.NeutronPluginBaseV2,
    ...
    def __init__(self):
        super(ContrailPluginBase, self).__init__()
    ...
    def update_network(self, context, network_id, network):
        """Update the attributes of a particular Virtual Network."""
    ...
    def create_subnet(self, context, subnet):
        """Create a new subnet, and assigns it a symbolic name."""
    ...
    def update_subnet(self, context, subnet_id, subnet):
        """Update the attributes of a particular subnet."""
    ...
    def _make_port_dict(self, port, fields=None):
        """Filter attributes of a port based on fields."""
    ...
    def update_router(self, context, router_id, router):
        """Update the attributes of a router."""
    ...
    def get_routers(self, context, filters=None, fields=None):
        """Retrieve all router identifiers."""
    ...
    def update_floatingip(self, context, fip_id, floatingip):
        """Update the attributes of a floating IP."""
    ...
    def get_floatingips(self, context, filters=None, fields=None):
        """Retrieve all floating ips identifiers."""
    ...
    def update_security_group(self, context, sg_id, security_group):
        """Update the attributes of a security group."""
    ...
    def get_security_groups(self, context, filters=None, fields=None,
                            ...
                            page_reverse=False):
        """Retrieve all security group identifiers."""
